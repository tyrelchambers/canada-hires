        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Providing transparency about Canadian businesses' use of the Temporary Foreign Worker program, 
              helping you support companies that prioritize hiring Canadians.
            </p>
            <p className="text-sm text-muted-foreground">
              Contact: <a href="mailto:contact@jobwatchcanada.com" className="text-blue-600 hover:underline">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/lmia" className="text-muted-foreground hover:text-foreground transition-colors">
                  LMIA Records
                </Link>
              </li>
              <li>
